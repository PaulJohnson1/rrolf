...
{
    init_loot_table(&RR_MOB_DATA[rr_mob_id_triceratops].loot[0], rr_petal_id_light, 0.25);
    init_loot_table(&RR_MOB_DATA[rr_mob_id_triceratops].loot[1], rr_petal_id_leaf, 0.25);

    init_loot_table(&RR_MOB_DATA[rr_mob_id_trex].loot[0], rr_petal_id_light, 0.25);

    init_loot_table(&RR_MOB_DATA[rr_mob_id_stump].loot[0], rr_petal_id_rock, 0.25);
