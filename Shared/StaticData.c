...
struct rr_petal_data RR_PETAL_DATA[rr_petal_id_max] = {
    ...
    {rr_petal_id_pellet, rr_rarity_id_common, 12.5f, 5.0f, 0.0f, 15, 0, {1, 2, 2, 3, 3, 5, 5}},
    ...
    {rr_petal_id_lightning, rr_rarity_id_unusual, 10.0f, 4.0f, 0.0f, 50, 25, {1, 1, 1, 1, 1, 1, 1}},
    {rr_petal_id_stick, rr_rarity_id_rare, 4.0f, 8.0f, 0.0f, 50, 0, {1, 1, 1, 1, 1, 1, 1}},
};    

struct rr_mob_data RR_MOB_DATA[rr_mob_id_max] = {
    {rr_mob_id_triceratops, rr_rarity_id_rare, 40, 15, 30.0f, {}},
