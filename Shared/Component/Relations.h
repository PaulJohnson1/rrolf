...
RR_SERVER_ONLY(void rr_component_relations_write(struct rr_component_relations *, struct rr_encoder *, int is_creation);)
RR_CLIENT_ONLY(void rr_component_relations_read(struct rr_component_relations *, struct rr_encoder *);)
