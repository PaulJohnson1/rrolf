...
namespace app
{
    ...
    */
    ...
    std::vector<Entity> const &SpatialHash::GetCollisions(int32_t _x, int32_t _y, int32_t _w, int32_t _h)
    {
    ...
    std::vector<Entity> const &SpatialHash::GetCollisions(Entity id)
    {
        // component::Physical &physical = m_Simulation.Get<component::Physical>(id);
        // int32_t entityX = (int32_t)physical.X();
        // int32_t entityY = (int32_t)physical.Y();
