                                       ...
                                       struct rr_game *game)
{
    ...
    rr_renderer_bezier_curve_to(renderer, 157.31, 44.35, 85.45, 73.66, 6.27, 73.66);
    rr_renderer_bezier_curve_to(renderer, -74.10, 73.66, -147.13, 43.40, -201.50, -5.76);
    rr_renderer_bezier_curve_to(renderer, -327.95, 27.33, -406.19, 140.31, -406.19, 275.28);
    rr_renderer_line_to(renderer, -406.19, 344.06);
    rr_renderer_bezier_curve_to(renderer, -406.19, 505.03, 406.20, 505.03, 406.20, 344.06);
    rr_renderer_line_to(renderer, 406.20, 275.28);
    rr_renderer_bezier_curve_to(renderer, 406.19, 143.86, 331.98, 32.77, 211.43, -3.40);
    rr_renderer_move_to(renderer, 6.27, 24.73);
    rr_renderer_bezier_curve_to(renderer, 146.43, 24.73, 260.36, -84.71, 260.36, -219.91);
    rr_renderer_bezier_curve_to(renderer, 260.36, -355.11, 146.67, -464.78, 6.27, -464.78);
    rr_renderer_bezier_curve_to(renderer, -133.66, -464.78, -247.59, -355.11, -247.59, -219.91);
    rr_renderer_bezier_curve_to(renderer, -247.59, -84.70, -133.66, 24.73, 6.27, 24.73);
    rr_renderer_fill(renderer);
}
...
static void render_link(struct rr_ui_element *this, struct rr_game *game)
{
    ...
    rr_renderer_bezier_curve_to(renderer, 8.71, -16.02, 5.78, -16.03, 3.97, -14.26);
    rr_renderer_line_to(renderer, -0.55, -9.85);
    rr_renderer_bezier_curve_to(renderer, -2.36, -8.08, -2.37, -5.20, -0.57, -3.42);
    rr_renderer_line_to(renderer, 2.02, -5.91);
    rr_renderer_bezier_curve_to(renderer, 1.75, -6.70, 2.08, -7.60, 2.72, -8.23);
    rr_renderer_line_to(renderer, 5.60, -11.04);
    rr_renderer_bezier_curve_to(renderer, 6.51, -11.92, 7.97, -11.92, 8.87, -11.03);
    rr_renderer_line_to(renderer, 11.32, -8.61);
    rr_renderer_bezier_curve_to(renderer, 12.22, -7.72, 12.22, -6.28, 11.31, -5.39);
    rr_renderer_line_to(renderer, 8.43, -2.59);
    rr_renderer_bezier_curve_to(renderer, 7.82, -1.99, 6.82, -1.67, 6.05, -1.87);
    ...
    rr_renderer_bezier_curve_to(renderer, 16.39, -5.55, 16.40, -8.43, 14.60, -10.21);
    rr_renderer_move_to(renderer, -1.97, 5.95);
    rr_renderer_bezier_curve_to(renderer, -1.76, 6.72, -2.10, 7.72, -2.72, 8.33);
    rr_renderer_line_to(renderer, -5.41, 10.96);
    rr_renderer_bezier_curve_to(renderer, -6.33, 11.86, -7.83, 11.85, -8.74, 10.94);
    rr_renderer_line_to(renderer, -11.24, 8.48);
    rr_renderer_bezier_curve_to(renderer, -12.16, 7.58, -12.15, 6.10, -11.23, 5.21);
    rr_renderer_line_to(renderer, -8.54, 2.58);
    rr_renderer_bezier_curve_to(renderer, -7.88, 1.94, -6.94, 1.62, -6.12, 1.89);
    rr_renderer_line_to(renderer, -3.52, -0.68);
    rr_renderer_bezier_curve_to(renderer, -5.36, -2.49, -8.35, -2.50, -10.19, -0.70);
    rr_renderer_line_to(renderer, -14.56, 3.56);
    rr_renderer_bezier_curve_to(renderer, -16.40, 5.37, -16.41, 8.30, -14.58, 10.11);
    rr_renderer_line_to(renderer, -10.42, 14.22);
    rr_renderer_bezier_curve_to(renderer, -8.59, 16.03, -5.60, 16.04, -3.75, 14.24);
    ...
    rr_renderer_bezier_curve_to(renderer, -4.20, 5.39, -3.20, 5.40, -2.57, 4.78);
    rr_renderer_line_to(renderer, 4.88, -2.63);
    rr_renderer_bezier_curve_to(renderer, 5.50, -3.25, 5.51, -4.25, 4.89, -4.87);
    rr_renderer_bezier_curve_to(renderer, 4.28, -5.48, 3.28, -5.48, 2.66, -4.87);
    rr_renderer_line_to(renderer, -4.80, 2.54);
    rr_renderer_bezier_curve_to(renderer, -5.42, 3.16, -5.42, 4.16, -4.81, 4.78);
    rr_renderer_fill(renderer);
}
